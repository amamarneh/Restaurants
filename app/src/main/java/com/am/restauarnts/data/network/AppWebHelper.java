...
public class AppWebHelper implements WebHelper {
    ...
    @Override
    public void getTopFood(int limit, ParsedRequestListener<TopFoodResponse> listener) {
        AndroidNetworking.get(ServerEndPoints.TOP_FOOD_GET_ALL)
                .addQueryParameter("limit", String.valueOf(limit))
                .build()
                .getAsObject(TopFoodResponse.class, listener);
    }
}
